    ...
    <div className='p-5 shadow-lg rounded-lg border-t-primary border-t-4 mt-10'>
      ...
      <div className='flex justify-between'>
        <div className='flex gap-2'>
          <Button variant="outline" onClick={AddNewEducation} className="text-white">+ Add More Education</Button>
          <Button variant="outline" onClick={RemoveEducation} className="text-white">- Remove</Button>
        </div>
        <Button disabled={loading} onClick={onSave} className={`px-4 py-2 rounded-md flex items-center gap-2 font-semibold transition ${loading ? 'bg-gray-400 text-white cursor-not-allowed' : 'bg-pink-600 text-white hover:bg-pink-700'}`}>
