    ...
    <div className="p-5 shadow-lg rounded-lg border-t-primary border-t-4 mt-10">
      ...
      <div className="flex flex-col sm:flex-row justify-between gap-4">
        <div className="flex gap-2 flex-wrap">
          <Button variant="outline" onClick={AddNewAchievement} className="theme-button">+ Add More</Button>
          <Button variant="outline" onClick={RemoveAchievement} className="theme-button">- Remove</Button>
        </div>
